...
public class Notepadv2 extends ListActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        case ACTIVITY_EDIT:
        	Long mRowId = extra.getLong(NotesDbAdapter.KEY_ROWID);
        	if (mRowId != null) {
        		String editTitle = extra.getString(NotesDbAdapter.KEY_TITLE);
        		String editBody = extra.getString(NotesDbAdapter.KEY_BODY);
